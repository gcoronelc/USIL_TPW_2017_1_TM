...
<div class="menu">
    ...
    <c:if test="${ permisos != null }">
      ...
      <c:if test="${ permisos.op1 == 'ACTIVO' }">
				<li><a href="#" ${ menuProcesos }>Procesos</a>
					<ul>
						<li><a href="#">Registrar Retiro</a></li>
			...
			<c:if test="${ permisos.op2 == 'ACTIVO' }">
				<li><a href="#" ${ menuTablas }>Tablas</a>
					<ul>
						<li><a href="crudAlumno.htm">Alumnos</a></li>
						<li><a href="verEmpleados.htm">Empleado</a></li>
						<li><a href="resumenSucursal.htm">Sucursal</a></li>
					</ul>
				</li>
			</c:if>
	    ...
	    <c:if test="${ permisos.op3 == 'ACTIVO' }">
		    <li><a href="#" ${ menuGenerales }>Consultas</a>
		      <ul>
		        ...
		        <li><a href="conClientes2.htm">Clientes por Sucursal</a></li>
